...
builder.Services.AddScoped<IUserFlawSummaryService, UserFlawSummaryService>();  // NEW
builder.Services.AddScoped<IOrgReportService, OrgReportService>(); //NEW
builder.Services.AddScoped<IAIKnowledgeService, AIKnowledgeService>(); //NEW
builder.Services.AddScoped<ICampaignGeneratorService, CampaignGeneratorService>(); //NEW
builder.Services.AddScoped<ITemplateExpansionService, TemplateExpansionService>(); //NEW
builder.Services.AddScoped<IScenarioReviewService, ScenarioReviewService>(); //NEW
